...
function getRandomEnemyByZone(zone, playerLevel) {
    ...
    var ZONE_ENEMY_WHITELIST = {
        ...
        // Corpus 区域白名单
        'v_zone1': [
            '船员', '大地船员', '气雾船员', '朱诺船员', '泰洛船员', '艾汐船员', '沃拉船员', '奥穆船员', '合一众船员',
            '德特昂船员', '气雾德特昂船员', '气雾德特昂突击队员', '泰洛德特昂船员', '艾汐德特昂船员', '沃拉德特昂船员', '奥穆德特昂船员', '合一众德特昂船员',
            '精英船员', '气雾精英船员', '气雾精英突击队员', '朱诺精英船员', '大地精英船员',
            '虚能船员', '气雾虚能船员', '气雾虚能突击队员', '朱诺虚能船员', '泰洛虚能船员', '艾汐虚能船员', '沃拉虚能船员', '奥穆虚能船员',
            '监工船员', '气雾监工船员', '合一众监工船员',
            '狙击手船员', '大地狙击手船员', '气雾狙击手船员', '气雾狙击手突击队员', '朱诺狙击手船员',
            'Corpus技师', '气雾技师', '朱诺技工', '气雾技师突击队员', '泰洛技师', '艾汐技工', '沃拉技工', '奥穆技工',
            '机械师', '朱诺锤骨机械师', '爆破型机械师',
            // 集气城市专属敌人
            '驱逐员（迷雾）', '驱逐员（虚无）', '驱逐员（衰竭）', '驱逐员（滞缓）',
            '扰敌员（迷雾）', '扰敌员（虚无）', '扰敌员（衰减）', '扰敌员（滞缓）',
            '引能船员', '资料师',
        ],
        'n_zone1': [
            '船员', '大地船员', '气雾船员', '朱诺船员', '泰洛船员', '艾汐船员', '沃拉船员', '奥穆船员', '合一众船员',
    ...
    // 根据派系选择前缀轮换系统
    var prefixRoll;
    if (faction === 'corpus' && typeof rollCorpusPrefix === 'function') {
        prefixRoll = rollCorpusPrefix();
    } else {
        prefixRoll = rollEnemyPrefix();
    }
